      ...
      <>
        <header className=" flex justify-center bg-red-600 h-32 items-center">
          <svg
            ...
            aria-hidden="true"
          >
            {/* <rect fill="#e7000b" width="100%" height="100%"></rect> */}
            <path
              fill="#FEFEFE"
        ...
        <div className="flex justify-center gap-6 p-4">
          <button
            className="disabled:bg-gray-500 flex justify-center items-center text-white w-16 h-16 hover:bg-red-600  bg-red-500 font-noto -skew-x-12 font-bold"
        ...
        <ul className="grid grid-cols-4 grid-flow-row gap-4 relative px-4 md:px-6">
